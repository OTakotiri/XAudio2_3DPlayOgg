#include "X3DAudioPlaySE.h"
#include "..\..\SoundManager.h"
CX3DAudioPlaySE::CX3DAudioPlaySE()
...
HRESULT CX3DAudioPlaySE::InitSourceVoice(const char * filename)
{
...
// 3D情報のアップデート関数.
//=============================
void CX3DAudioPlaySE::Update3DSound()
{
	if (this == nullptr) return;
	if (CSoundManager::GetInstance()->GetEndAppFlag() == true) return;
	// 音が再生されていれば更新.
	for (int Array = 0; Array < SE_VOICE_SIZE; Array++) {
		if (IsPlayingSE(Array) == true) {
			m_pX3DAudio[Array]->Apply3DSoundValue(true);
		}
	}
}
//=============================
...
// 再生されていないソースボイスを探す.
//=============================
int CX3DAudioPlaySE::CheckPlaySeBuffer()
{
...
//=============================
const bool CX3DAudioPlaySE::IsPlayingSE(size_t ArrayNum)
{
...
// サウンド再生.
//=============================
bool CX3DAudioPlaySE::Play()
{
	if (this == nullptr) return false;
	if (CSoundManager::GetInstance()->GetEndAppFlag() == true) return false;
	HRESULT hr;
	int Array = 0;
...
//=============================
bool CX3DAudioPlaySE::NoMultiplePlay()
{
	if (this == nullptr) return false;
	HRESULT hr;
...
// SE停止.
//=============================
bool CX3DAudioPlaySE::SeStop(const size_t ArrayNum)
{
	if (this == nullptr) return false;
...
// 作成してる予備含む全てのSE停止.
//=============================
bool CX3DAudioPlaySE::AllSeStop()
{
	if (this == nullptr) return false;
	if (m_pSourceVoice[0] == nullptr) return true;
...
// Oggデータ作成.
//=============================
HRESULT CX3DAudioPlaySE::CreateOggSound()
{
	//一回データが作られていたらリターン.
	...
	for (size_t Array = 0; Array < SE_VOICE_SIZE; Array++) {
		...
		if (FAILED(hr = pHandle->CreateSourceVoice(&m_pSourceVoice[Array], m_pOggWavData->GetFormat(),0,5.0f,nullptr,&sendList)))
		{
			// 失敗した.
...
//=============================
void CX3DAudioPlaySE::SetListenerInfo(CX3DAudio::AUDIO_LISTENER& stListenerData)
{
	if (this == nullptr) return;
...
//=============================
void CX3DAudioPlaySE::SetEmitterInfo(CX3DAudio::AUDIO_EMITTER& stEmitterData)
{
	if (this == nullptr) return;
	if (m_pX3DAudio[0] == nullptr) return;
	for (size_t Array = 0; Array < SE_VOICE_SIZE; Array++) {
...
// リバーブを設定.
//=============================
HRESULT CX3DAudioPlaySE::SetReverb(const XAudio2Reverb::enReverbPreset Preset)
{
...
//=============================
void CX3DAudioPlaySE::SetUseListenerConeFlag(const bool isFlag)
{
	if (this == nullptr) return;
	if (m_pX3DAudio[0] == nullptr) return;
	for (size_t Array = 0; Array < SE_VOICE_SIZE; Array++) {
...
//=============================
void CX3DAudioPlaySE::SetUseInnerRadiusFlag(const bool isFlag)
{
	if (this == nullptr) return;
	if (m_pX3DAudio[0] == nullptr) return;
	for (size_t Array = 0; Array < SE_VOICE_SIZE; Array++) {
...
//=============================
void CX3DAudioPlaySE::SetUseDopplerFlag(const bool isFlag)
{
	if (this == nullptr) return;
	if (m_pX3DAudio[0] == nullptr) return;
	for (size_t Array = 0; Array < SE_VOICE_SIZE; Array++) {
...
// 音量取得.
//=============================
const float CX3DAudioPlaySE::GetSEVolume(size_t Array)
{
...
// SE音量設定.
//=============================
bool CX3DAudioPlaySE::SetSEVolume(float value, size_t Array)
{
	if (this == nullptr) return false;
...
// ソースボイス解放.
//=============================
void CX3DAudioPlaySE::DestoroySource()
{
	if (this == nullptr) return;
